...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/tuto_cull_export
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_cull_export
  DEFINES   += -DDEBUG
...
ifeq ($(config),release)
  OBJDIR     = obj/release/tuto_cull_export
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_cull_export
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
clean:
	@echo Cleaning tuto_cull_export
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/app.o: src/gKit/app.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tuto_cull_export.o: projets/tuto_cull_export.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
