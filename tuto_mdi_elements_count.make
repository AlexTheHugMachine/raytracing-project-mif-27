...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/tuto_mdi_elements_count
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_mdi_elements_count
  DEFINES   += -DDEBUG
...
ifeq ($(config),release)
  OBJDIR     = obj/release/tuto_mdi_elements_count
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_mdi_elements_count
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
OBJECTS := \
	...
	$(OBJDIR)/cgltf.o \
	$(OBJDIR)/app.o \
	$(OBJDIR)/tuto_mdi_elements_count.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking tuto_mdi_elements_count
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning tuto_mdi_elements_count
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/app.o: src/gKit/app.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tuto_mdi_elements_count.o: tutos/M2/tuto_mdi_elements_count.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
