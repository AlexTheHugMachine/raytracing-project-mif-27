...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/tuto_mdi_elements
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_mdi_elements
  DEFINES   += -DDEBUG
...
ifeq ($(config),release)
  OBJDIR     = obj/release/tuto_mdi_elements
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_mdi_elements
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking tuto_mdi_elements
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning tuto_mdi_elements
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/app.o: src/gKit/app.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tuto_mdi_elements.o: tutos/M2/tuto_mdi_elements.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
